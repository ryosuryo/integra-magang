	...
	<div class="box-body">
		<form method="POST">
			...
			<div class="form-group">
				...
				<select name="id_periode_magang" class="form-control">
					<option value="">- Pilih Mahasiswa -</option>
					<?php foreach($magang as $key => $value): ?>
						<option value="<?php echo $value ['id_magang'] ?>" <?php if($value['id_magang']==$detail['id_magang']){echo "selected";} ?>><?php echo $value
			...
			<div class="form-group">
				...
				<select name="hari_magang" class="form-control">
					...
					<?php foreach($hari as $key => $nama_hari): ?>
						<option value="<?php echo $nama_hari ?>" <?php if($nama_hari==$detail['hari_magang']){echo "selected";} ?>><?php echo $nama_hari; ?></option>
						<?php endforeach ?>
				</select>
			</div>
